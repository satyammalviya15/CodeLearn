  ...
  const enrollCourse = async () => {
    try {
      if (!userData || userData.length === 0) {
        toast.warn("Please sign in to enroll in the course.");
        return;
      }
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1
            className="md:text-course-deatails-heading-large  md:text-4xl 
          text-2xl
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">CodeLearn</span>
          </p>
                              ...
                              {lecture.isPreviewFree && (
                                <p
                                  onClick={() => {
                                    ...
                                    setPlayerData({ videoId: extractYouTubeID(lecture.lectureUrl) });
                                  }}
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-1">
                ...
                <p>{calculateNoOfLeactures(courseData)} lessons</p>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Quizzes of test your knowledge.</li>
                <li>Certificate of compiletion.</li>
              </ul>
            </div>
          </div>
        </div>
